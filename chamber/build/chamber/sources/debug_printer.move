...
module chamber::end_to_end_test {
    ...
    fun test_complete_staking_flow() {
        ...
        printer::print_str(b"- Stake SUI → Get stSUI");
        printer::print_str(b"- stSUI automatically appreciates as rewards accrue");
        printer::print_str(b"- No lockups, claim rewards any time");
        printer::print_str(b"- Coming soon to Sui Network!");
